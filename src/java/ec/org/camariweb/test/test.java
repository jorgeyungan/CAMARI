...
public class test {
    public static void main(String[] args) {
        ...
        //----------- Ingreso de usuarios-----------------\\
       //--------------------------------------------------\\
//        clsCliente cli = new clsCliente(1, "1600572760", "angie Paucar", "Puyo");
//        crudCliente clien = new crudCliente();
...
//        System.out.println(clien.findbyid(cli).toString());
//        System.out.println("=============================================");
//        System.out.println("=============================================");
...
//       ----------- Ingreso de Factura-----------------\\
//      --------------------------------------------------\\
//       clsFactura factur = new clsFactura(1, cli,null, 1220.12, 20.45, 1686.72);
// 
